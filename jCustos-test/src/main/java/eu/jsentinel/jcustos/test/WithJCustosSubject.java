...
/**
 * Test annotation that binds a {@code JCustosSubject} with the
 * declared roles and permissions for the duration of a JUnit-5 test
 * method (or every test method of an annotated class).
 *
 * <p>Activated by {@link JCustosTestExtension}; combine via
 * {@code @ExtendWith(JCustosTestExtension.class)} on the test
 * class.
 *
 * <pre>
...
public @interface WithJCustosSubject {
