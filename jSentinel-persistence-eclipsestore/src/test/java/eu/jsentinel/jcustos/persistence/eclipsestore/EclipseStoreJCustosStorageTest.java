...
class EclipseStoreJCustosStorageTest {
  ...
  void closeIsIdempotent() {
    ...
    EclipseStoreJCustosStorage storage =
        EclipseStoreJCustosStorage.openAt(tempDir);
    storage.close();
  ...
  void openAtSamePathTwice_secondFails() {
    try (EclipseStoreJCustosStorage first =
             EclipseStoreJCustosStorage.openAt(tempDir)) {
