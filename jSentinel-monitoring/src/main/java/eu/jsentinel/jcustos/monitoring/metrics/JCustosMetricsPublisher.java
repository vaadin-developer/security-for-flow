...
/**
 * Backend-neutral export point for jCustos operational metrics.
 *
 ...
 * {@link JCustosMetricsPublishers#discover()}) or by wiring an
 * instance programmatically. The default is
 * {@link NoOpJCustosMetricsPublisher}, which records nothing —
 ...
 * {@link JCustosMetricNames}, the single source of truth for the
...
public interface JCustosMetricsPublisher {
   ...
   *
   * @param counterName a counter name from {@link JCustosMetricNames}
   ...
   *
   * @param gaugeName a gauge name from {@link JCustosMetricNames}
