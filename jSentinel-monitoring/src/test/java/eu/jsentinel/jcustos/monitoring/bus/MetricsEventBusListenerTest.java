...
import eu.jsentinel.jcustos.events.types.LogoutSucceededEvent;
import eu.jsentinel.jcustos.events.types.PermissionDeniedEvent;
import eu.jsentinel.jcustos.events.types.PolicyDeniedEvent;
import eu.jsentinel.jcustos.events.types.RateLimitExceededEvent;
...
import eu.jsentinel.jcustos.events.types.SessionExpiredEvent;
