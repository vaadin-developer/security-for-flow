 ...
 * {@link PasswordResetCompleted} consume event without ever
 * touching the credential material itself.
 *
 * @param timestamp UTC creation time; non-null
 * @param subjectId subject the token was issued for; non-blank
 * @param tokenHash hash of the issued token; non-blank
 */
