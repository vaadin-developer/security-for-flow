...
/**
 * Generic evaluator for {@link RequiresRole}.
 */
public final class RequiresRoleEvaluator implements AuthorizationEvaluator<RequiresRole> {

  @Override
  public AuthorizationDecision evaluate(AccessContext context, RequiresRole annotation) {
