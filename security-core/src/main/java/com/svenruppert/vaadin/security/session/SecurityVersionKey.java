...
/**
 * Composite key under which {@link SecurityVersionStore} tracks the
 * current {@link SecurityVersion} of a subject.
 * <p>
 ...
 * {@code SecurityVersionCheck} interceptor relies on.
 *
 * @param tenant    tenant scope; {@code null} becomes {@link TenantId#DEFAULT}
 * @param subjectId subject identifier; non-null
 */
@ExperimentalSecurityApi
public record SecurityVersionKey(TenantId tenant, SubjectId subjectId) {
