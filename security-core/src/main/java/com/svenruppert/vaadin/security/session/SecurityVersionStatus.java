...
/**
 * Result of a {@link SecurityVersionCheck#check} call against a
...
public sealed interface SecurityVersionStatus {
   ...
   *           {@link SecurityVersionCheck} current value
   */
  record Current(SecurityVersion at) implements SecurityVersionStatus {
    ...
    @Override
    public SecurityVersion snapshot() {
      return at;
    }

    @Override
    public SecurityVersion current() {
      return at;
    }
  }
   ...
   */
  record Drifted(SecurityVersion snapshot, SecurityVersion current) implements SecurityVersionStatus {
