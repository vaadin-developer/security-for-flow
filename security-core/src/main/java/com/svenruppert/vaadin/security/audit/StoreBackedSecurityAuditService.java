...
/**
 * {@link SecurityAuditService} that persists events through an
...
public final class StoreBackedSecurityAuditService implements SecurityAuditService {
   ...
   */
  public StoreBackedSecurityAuditService(AuditEventStore store) {
   ...
   */
  public StoreBackedSecurityAuditService(AuditEventStore store, TenantId tenant) {
