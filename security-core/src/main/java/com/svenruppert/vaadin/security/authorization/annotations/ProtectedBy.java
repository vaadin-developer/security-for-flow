...
import com.svenruppert.vaadin.security.authorization.api.ProtectedByEvaluator;
...
@Target({TYPE, METHOD})
@SecurityAnnotation(ProtectedByEvaluator.class)
public @interface ProtectedBy {
   ...
   */
  Class<? extends AuthorizationEvaluator<ProtectedBy>> value();
}
