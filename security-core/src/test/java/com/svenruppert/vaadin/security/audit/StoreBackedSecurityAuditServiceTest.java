...
@DisplayName("StoreBackedSecurityAuditService")
class StoreBackedSecurityAuditServiceTest {
  ...
  void publishAndQueryRoundtrip() {
    ...
    StoreBackedSecurityAuditService service = new StoreBackedSecurityAuditService(store);
  ...
  void publishSwallowsStoreFailures() {
    ...
    StoreBackedSecurityAuditService service =
        new StoreBackedSecurityAuditService(failingStore);
  ...
  void queryIsTenantScoped() {
    ...
    StoreBackedSecurityAuditService defaultService = new StoreBackedSecurityAuditService(store);
    StoreBackedSecurityAuditService acmeService =
        new StoreBackedSecurityAuditService(store, acme);
  ...
  void nullTenantBecomesDefault() {
    InMemoryAuditEventStore store = new InMemoryAuditEventStore();
    StoreBackedSecurityAuditService service =
        new StoreBackedSecurityAuditService(store, null);
  ...
  void rejectNulls() {
    assertThrows(NullPointerException.class,
        () -> new StoreBackedSecurityAuditService(null));
    InMemoryAuditEventStore store = new InMemoryAuditEventStore();
    StoreBackedSecurityAuditService service = new StoreBackedSecurityAuditService(store);
