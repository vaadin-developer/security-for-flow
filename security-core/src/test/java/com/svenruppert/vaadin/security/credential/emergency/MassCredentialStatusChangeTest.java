...
class MassCredentialStatusChangeTest {
  ...
  void staleSurfacesAsCount() {
    ...
    com.svenruppert.vaadin.security.credential.store.CredentialStore alwaysStale =
        new com.svenruppert.vaadin.security.credential.store.CredentialStore() {
          ...
          @Override public com.svenruppert.vaadin.security.credential.store.CredentialUpdateResult
              updateHashIfCurrent(String u, String expected, String now, Instant when) {
            return com.svenruppert.vaadin.security.credential.store
