...
@DisplayName("NoopJSentinelAuditService")
class NoopJSentinelAuditServiceTest {

  @Test
  @DisplayName("publish silently discards the event")
  void publishIsSilent() {
    NoopJSentinelAuditService.INSTANCE.publish(
  ...
  void publishTolerantOfNull() {
    NoopJSentinelAuditService.INSTANCE.publish(null);
  }

  @Test
  @DisplayName("query returns an empty list regardless of the filter")
  void queryReturnsEmpty() {
    assertTrue(NoopJSentinelAuditService.INSTANCE.query(AuditQuery.all()).isEmpty());
    assertTrue(NoopJSentinelAuditService.INSTANCE
