 ...
 * Eclipse-Store layer at {@code ./data/jsentinel-vaadin-persistence} and registers a
...
public final class JSentinelStorageProvider {
  ...
  public static final Path DEFAULT_STORAGE_DIR = Path.of("./data/jsentinel-vaadin-persistence");
