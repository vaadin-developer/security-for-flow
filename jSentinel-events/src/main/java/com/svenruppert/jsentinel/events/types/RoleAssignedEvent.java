...
/**
 * A role was assigned to a subject (Konzept §255).
 *
...
public record RoleAssignedEvent(EventMetadata metadata, String role)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("RoleAssigned");
