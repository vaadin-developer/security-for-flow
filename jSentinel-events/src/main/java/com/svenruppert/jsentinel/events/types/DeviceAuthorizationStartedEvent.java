...
/**
 * A device-authorization grant was started — a {@code device_code} +
 * {@code user_code} were issued (RFC 8628, V00.77). No secret payload (the
 * device_code is not carried).
 *
 * @param metadata variable per-instance metadata
 * @since 00.77.00
 */
@ExperimentalJSentinelApi
public record DeviceAuthorizationStartedEvent(EventMetadata metadata) implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("DeviceAuthorizationStarted");

  public DeviceAuthorizationStartedEvent {
