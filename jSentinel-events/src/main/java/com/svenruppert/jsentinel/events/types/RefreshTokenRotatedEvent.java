...
/**
 * A refresh token was rotated (Konzept §272).
 *
 * @param metadata variable per-instance metadata
 * @param tokenId opaque (new) token identifier
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record RefreshTokenRotatedEvent(EventMetadata metadata, String tokenId)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("RefreshTokenRotated");

  public RefreshTokenRotatedEvent {
