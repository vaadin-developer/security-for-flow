...
/**
 * A subject authenticated successfully (Konzept §223).
 *
 * @param metadata variable per-instance metadata
 * @param authenticationMethod e.g. {@code "password"}, {@code "api-key"}
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record LoginSucceededEvent(EventMetadata metadata, String authenticationMethod)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("LoginSucceeded");
