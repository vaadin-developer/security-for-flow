...
/**
 * An API key was issued (Konzept §269).
 *
 * @param metadata variable per-instance metadata
 * @param apiKeyId opaque API-key identifier
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record ApiKeyIssuedEvent(EventMetadata metadata, String apiKeyId)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("ApiKeyIssued");

  public ApiKeyIssuedEvent {
