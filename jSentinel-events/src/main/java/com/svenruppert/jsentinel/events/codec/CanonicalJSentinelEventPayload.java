 ...
 * arbitrary {@code JSentinelEvent} implementation, so the signature base stays
...
public record CanonicalJSentinelEventPayload(
    int schemaVersion,
    String eventType,
    String eventId,
    String tenantId,
  ...
  public CanonicalJSentinelEventPayload {
