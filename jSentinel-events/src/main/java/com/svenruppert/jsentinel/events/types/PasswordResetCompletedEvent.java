...
/**
 * A password reset completed successfully (Konzept §228).
 *
 * @param metadata variable per-instance metadata
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record PasswordResetCompletedEvent(EventMetadata metadata)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("PasswordResetCompleted");
