...
/**
 * A brute-force detection threshold was reached (Konzept §280).
 *
 * @param metadata variable per-instance metadata
 * @param identifier the throttled identifier (e.g. normalized username / IP)
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record BruteForceThresholdReachedEvent(EventMetadata metadata, String identifier)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("BruteForceThresholdReached");

  public BruteForceThresholdReachedEvent {
