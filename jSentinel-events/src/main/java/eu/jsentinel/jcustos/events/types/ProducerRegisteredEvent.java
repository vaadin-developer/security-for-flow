...
/**
 * A producer was registered with the bus (Konzept §286 — bus lifecycle).
 *
 * @param metadata variable per-instance metadata
 * @param producerId the registered producer id
 * @since 00.75.00
 */
@ExperimentalJCustosApi
public record ProducerRegisteredEvent(EventMetadata metadata, String producerId)
    implements JCustosEvent {

  public static final EventType TYPE = EventType.of("ProducerRegistered");

  public ProducerRegisteredEvent {
  ...
  public JCustosEventCategory category() {
    return JCustosEventCategory.SYSTEM;
  }
}
