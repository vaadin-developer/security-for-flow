...
/**
 * A named policy was evaluated (Konzept §237).
 *
 * @param metadata variable per-instance metadata
 * @param policyName the evaluated policy
 * @param decision the resulting decision, e.g. {@code "allow"} / {@code "deny"}
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record PolicyEvaluatedEvent(EventMetadata metadata, String policyName, String decision)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("PolicyEvaluated");
  ...
  public JSentinelEventCategory category() {
    return JSentinelEventCategory.POLICY;
  }
}
