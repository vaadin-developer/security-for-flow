...
/**
 * A tenant-scoped security policy changed (Konzept §258). Consumers may need
 * to re-evaluate active access for the affected tenant.
 *
...
public record TenantPolicyChangedEvent(EventMetadata metadata, String policyName)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("TenantPolicyChanged");

  public TenantPolicyChangedEvent {
  ...
  public JSentinelEventCategory category() {
    return JSentinelEventCategory.ADMIN;
  }
}
