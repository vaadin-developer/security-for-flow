...
/**
 * A password reset was requested (Konzept §227). Carries the opaque reset
 * token id, never the token secret.
 *
 * @param metadata variable per-instance metadata
 * @param resetTokenId opaque token identifier
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record PasswordResetRequestedEvent(EventMetadata metadata, String resetTokenId)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("PasswordResetRequested");
