...
/**
 * A policy evaluation denied access (Konzept §238).
 *
 * @param metadata variable per-instance metadata
 * @param policyName the policy that denied access
 * @since 00.75.00
 */
@ExperimentalJSentinelApi
public record PolicyDeniedEvent(EventMetadata metadata, String policyName)
    implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("PolicyDenied");

  public PolicyDeniedEvent {
