...
/**
 * A signing key was rotated (Konzept §608 — key rotation). System-scoped.
 *
 * @param metadata variable per-instance metadata
 * @param keyId the newly active key id
 * @since 00.75.00
 */
@ExperimentalJCustosApi
public record KeyRotatedEvent(EventMetadata metadata, String keyId)
    implements JCustosEvent {

  public static final EventType TYPE = EventType.of("KeyRotated");
