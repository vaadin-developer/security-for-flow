...
/**
 * The event bus started (Konzept §286 — bus lifecycle). System-scoped.
 *
 * @param metadata variable per-instance metadata
 * @since 00.75.00
 */
@ExperimentalJCustosApi
public record BusStartedEvent(EventMetadata metadata) implements JCustosEvent {

  public static final EventType TYPE = EventType.of("BusStarted");

  public BusStartedEvent {
