...
/**
 * An OIDC RP-initiated logout was started (V00.78). Non-secret payload: the issuer
 * only — never the id_token_hint.
 *
 * @param metadata variable per-instance metadata
 * @param issuer   the OIDC issuer the session belonged to
 * @since 00.78.00
 */
@ExperimentalJSentinelApi
public record OidcLogoutEvent(EventMetadata metadata, String issuer) implements JSentinelEvent {

  public static final EventType TYPE = EventType.of("OidcLogout");

  public OidcLogoutEvent {
