...
class InMemoryKeyManagementContractTest implements KeyManagementContract<InMemoryKeyManagement> {
  public InMemoryKeyManagement newKeyManagement() {
    return new InMemoryKeyManagement(new Ed25519SignatureAlgorithm(), KeyId.of("k-1"));
  }
}
