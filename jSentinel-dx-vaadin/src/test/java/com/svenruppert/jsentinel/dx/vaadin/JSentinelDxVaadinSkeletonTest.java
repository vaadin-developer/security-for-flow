 ...
 */
package com.svenruppert.jsentinel.dx.vaadin;
...
class JSentinelDxVaadinSkeletonTest {
  ...
  void bootstrapPackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.vaadin.bootstrap");
  }

  @Test
  void runtimePackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.vaadin.runtime");
  }
}
