...
public interface VaadinJSentinelBootstrap
   ...
   * {@code JSentinelServiceResolver.setStepUpRouteName(...)}.
   *
   ...
   * @return this builder
   */
  VaadinJSentinelBootstrap discoverSecureRoutes(boolean enabled);

  /**
   * V00.73 (Konzept §8.5): escape hatch — registers a custom
   * {@link com.svenruppert.jsentinel.starter.routes.SecureRouteDiscovery}
   ...
   * @return this builder
   */
  default VaadinJSentinelBootstrap use(
      java.util.function.Consumer<? super VaadinJSentinelBootstrap> profile) {
