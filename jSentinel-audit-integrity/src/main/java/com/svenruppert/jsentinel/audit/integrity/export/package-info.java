 ...
 * {@link com.svenruppert.jsentinel.audit.integrity.export.AuditBatchSigner}
 * signs a contiguous range into a
 * {@link com.svenruppert.jsentinel.audit.integrity.export.SignedAuditBatch}
 * (the chain binds every entry, the signature binds the chain — using the
 * events key/signature SPIs, no second signing stack),
 * {@link com.svenruppert.jsentinel.audit.integrity.export.AuditExportService}
 * produces exports, and
 * {@link com.svenruppert.jsentinel.audit.integrity.export.AuditExportNdjsonCodec}
 * carries them as {@code application/x-ndjson} — re-verifiable via
 * {@link com.svenruppert.jsentinel.audit.integrity.export.AuditBatchVerifier}
