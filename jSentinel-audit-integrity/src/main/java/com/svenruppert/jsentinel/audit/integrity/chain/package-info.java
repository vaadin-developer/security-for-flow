 ...
 * {@link com.svenruppert.jsentinel.audit.integrity.chain.AuditChainEntryHasher}
 * is the single home of the hash-base byte layout,
 * {@link com.svenruppert.jsentinel.audit.integrity.chain.AuditChainAppender}
 * the chain's only writer (linkage-CAS with bounded retry), and
 * {@link com.svenruppert.jsentinel.audit.integrity.chain.InMemoryAuditChainStore}
