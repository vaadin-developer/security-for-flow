...
/**
 * Static factories for typical {@link SecuritySubject} test fixtures.
 */
public final class SecuritySubjects {

  private SecuritySubjects() {
  }
   ...
   * @return subject
   */
  public static SecuritySubject anonymousIdentity(String subjectId) {
    return new SecuritySubject(subjectId, subjectId, Set.of(), Set.of());
  }
   ...
   * @return subject
   */
  public static SecuritySubject withRoles(String subjectId, String... roleNames) {
    return new SecuritySubject(subjectId, subjectId,
   ...
   * @return subject
   */
  public static SecuritySubject withPermissions(String subjectId, String... permissionNames) {
    return new SecuritySubject(subjectId, subjectId,
        Set.of(),
   ...
   * @return subject
   */
  public static SecuritySubject of(
