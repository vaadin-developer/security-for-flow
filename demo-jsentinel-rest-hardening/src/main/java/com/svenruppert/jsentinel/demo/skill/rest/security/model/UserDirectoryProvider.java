 ...
 * under {@code ./data/jsentinel-rest-persistence/users}, then injects it into a
...
public final class UserDirectoryProvider {
  ...
  public static final Path USERS_STORAGE_DIR = Path.of("./data/jsentinel-rest-persistence/users");
