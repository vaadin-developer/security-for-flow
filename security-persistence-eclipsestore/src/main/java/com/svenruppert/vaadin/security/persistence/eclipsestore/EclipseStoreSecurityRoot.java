...
import com.svenruppert.vaadin.security.authentication.RefreshTokenRecord;
import com.svenruppert.vaadin.security.authentication.RememberMeTokenRecord;
 ...
 * reference; the {@link EclipseStoreSecurityStorage} lifecycle owns
 ...
 * module is the {@link EclipseStoreSecurityStorage} facade plus the
 * Phase-2 store SPIs.
 *
 * <p>Plan exit criterion: <em>no public API type called
 * {@code SecurityRoot}</em>. This class is package-private; its name
