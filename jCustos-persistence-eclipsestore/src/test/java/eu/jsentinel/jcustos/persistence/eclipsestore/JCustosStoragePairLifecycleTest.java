...
/**
 * Lifecycle tests for {@link JCustosStoragePair#close()} that exercise
 ...
 * </ol>
 */
class JCustosStoragePairLifecycleTest {
  ...
  void phase1Failure_phase2RunsAndExceptionIsRethrown() {
    ...
    EclipseStoreJCustosStorage framework =
        EclipseStoreJCustosStorage.openAt(frameworkDir);
    ...
    JCustosStoragePair pair = new JCustosStoragePair(
  ...
  void phase2Failure_pure() {
    ...
    EmbeddedStorageManager realFrameworkMgr =
        EclipseStoreJCustosStorage.initStorageManager(frameworkDir);
    ...
    EclipseStoreJCustosStorage framework =
        new EclipseStoreJCustosStorage(failingFrameworkMgr);
