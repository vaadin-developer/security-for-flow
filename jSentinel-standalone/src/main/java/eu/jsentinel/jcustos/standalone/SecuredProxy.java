...
import eu.jsentinel.jcustos.authorization.api.JCustosEnforcer;
 ...
 * invocation routes through {@link JCustosEnforcer}: if the method (or
 ...
 * {@link eu.jsentinel.jcustos.authorization.annotations.Secured}
 * get a {@code <Type>Secured} subclass generated by
 * {@code security-processor}. Both paths share the same
 * {@link JCustosEnforcer} so the rules are consistent.
 *
 ...
 * and assembles a {@link eu.jsentinel.jcustos.authorization.api.JCustosSubject}
...
public final class SecuredProxy {
  ...
  public static <T> T wrap(Class<T> interfaceType, T delegate) {
    ...
    return (T) Proxy.newProxyInstance(
        ...
        (proxy, method, args) -> {
          ...
          JCustosEnforcer.enforce(method, interfaceType);
  ...
  public static void requireAllowed(Class<?> ownerClass, String methodName) {
    ...
    JCustosEnforcer.enforce(method, ownerClass);
  }
}
