...
/**
 * A subject logged out (Konzept §225).
 *
...
public record LogoutSucceededEvent(EventMetadata metadata, String sessionId)
    implements JCustosEvent {

  public static final EventType TYPE = EventType.of("LogoutSucceeded");

  public LogoutSucceededEvent {
