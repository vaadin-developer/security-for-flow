...
/**
 * A session was created (Konzept §245).
 *
...
public record SessionCreatedEvent(EventMetadata metadata, String sessionId)
    implements JCustosEvent {

  public static final EventType TYPE = EventType.of("SessionCreated");
