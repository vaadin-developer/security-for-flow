...
/**
 * A subject's email address was verified (Konzept §230).
 *
 * @param metadata variable per-instance metadata
 * @param emailFingerprint a non-reversible fingerprint of the address
 * @since 00.75.00
 */
@ExperimentalJCustosApi
public record EmailVerifiedEvent(EventMetadata metadata, String emailFingerprint)
    implements JCustosEvent {

  public static final EventType TYPE = EventType.of("EmailVerified");
