...
/**
 * An API key was revoked (Konzept §271).
 *
...
public record ApiKeyRevokedEvent(EventMetadata metadata, String apiKeyId)
    implements JCustosEvent {

  public static final EventType TYPE = EventType.of("ApiKeyRevoked");
