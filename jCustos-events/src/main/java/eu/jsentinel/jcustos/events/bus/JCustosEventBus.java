...
public interface JCustosEventBus {
   ...
   */
  void publish(JCustosEvent event);
   ...
   */
  CompletionStage<Void> publishAsync(JCustosEvent event);
   ...
   */
  <E extends JCustosEvent> Registration subscribe(
