...
/**
 * A typed, security-relevant event in the jCustos Security Event Bus.
 *
...
public interface JCustosEvent {
   ...
   */
  default JCustosEventSeverity severity() {
