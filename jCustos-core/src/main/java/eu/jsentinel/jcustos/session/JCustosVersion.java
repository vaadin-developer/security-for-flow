 ...
 * {@code JCustosVersionCheck} (planned for V00.70 Phase 4) compares
...
public record JCustosVersion(long value) implements Comparable<JCustosVersion> {

  /**
   * Initial version (zero) — the value used when a subject is first
   * persisted.
   */
  public static final JCustosVersion INITIAL = new JCustosVersion(0L);
   ...
   */
  public JCustosVersion next() {
    return new JCustosVersion(value + 1);
  }

  @Override
  public int compareTo(JCustosVersion other) {
