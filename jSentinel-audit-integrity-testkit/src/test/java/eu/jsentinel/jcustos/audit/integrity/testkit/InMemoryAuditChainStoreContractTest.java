...
/** Runs the shared contract against the in-memory reference store. */
class InMemoryAuditChainStoreContractTest implements AuditChainStoreContract {

  @Override
  public AuditChainStore newChainStore() {
    return new InMemoryAuditChainStore();
  }
}
