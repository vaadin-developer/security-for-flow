...
class JCustosAutoServiceAnnotationTest {

  @Test
  void annotationHasSourceRetention() {
    Retention retention = JCustosAutoService.class.getAnnotation(Retention.class);
  ...
  void annotationTargetsType() {
    Target target = JCustosAutoService.class.getAnnotation(Target.class);
