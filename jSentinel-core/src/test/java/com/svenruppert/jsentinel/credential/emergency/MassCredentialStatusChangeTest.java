 ...
 * #L%
 */
package com.svenruppert.jsentinel.credential.emergency;

import com.svenruppert.jsentinel.audit.AuditEvent;
import com.svenruppert.jsentinel.audit.AuditQuery;
import com.svenruppert.jsentinel.audit.CredentialStatusChanged;
...
class MassCredentialStatusChangeTest {
  ...
  void staleSurfacesAsCount() {
    ...
    com.svenruppert.jsentinel.credential.store.CredentialStore alwaysStale =
        new com.svenruppert.jsentinel.credential.store.CredentialStore() {
          ...
          @Override public com.svenruppert.jsentinel.credential.store.CredentialUpdateResult
              updateHashIfCurrent(String u, String expected, String now, Instant when) {
            return com.svenruppert.jsentinel.credential.store
