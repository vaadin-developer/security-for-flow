...
class JSentinelEnforcerTest {
  ...
  void setUp() {
    ...
    JSentinelServiceResolver.setAuthorizationService(new TestAuthz());
    store = new HeapSubjectStore();
    SubjectStores.setSubjectStore(store);
    policies = new FixedRegistry();
    JSentinelServiceResolver.setPolicyRegistry(policies);
  }
  ...
  void requirePermissionHeld() {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.requirePermission("doc:read"));
  }
  ...
  void requirePermissionMissing() {
    ...
    AccessDeniedException ex = assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.requirePermission("doc:delete"));
  ...
  void requirePermissionNoSubject() {
    AccessDeniedException ex = assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.requirePermission("doc:read"));
  ...
  void requireAllPermissionsHeld() {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.requireAllPermissions("doc:read", "doc:write"));
  }
  ...
  void requireAllPermissionsOneMissing() {
    bind(new TestUser("alice", Set.of(), Set.of("doc:read")));
    AccessDeniedException ex = assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.requireAllPermissions("doc:read", "doc:write"));
  ...
  void requireAllPermissionsEmpty() {
    ...
    assertThrows(IllegalArgumentException.class,
        () -> JSentinelEnforcer.requireAllPermissions());
    assertThrows(IllegalArgumentException.class,
        () -> JSentinelEnforcer.requireAllPermissions((String[]) null));
  }
  ...
  void requireAnyPermissionOneHeld() {
    bind(new TestUser("alice", Set.of(), Set.of("doc:read")));
    assertDoesNotThrow(() -> JSentinelEnforcer.requireAnyPermission("doc:write", "doc:read"));
  }
  ...
  void requireAnyPermissionNoneHeld() {
    bind(new TestUser("alice", Set.of(), Set.of("doc:read")));
    AccessDeniedException ex = assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.requireAnyPermission("doc:delete", "doc:purge"));
    assertTrue(ex.getMessage().contains("doc:delete"));
  ...
  void requireAnyPermissionEmpty() {
    bind(new TestUser("alice", Set.of(), Set.of("doc:read")));
    assertThrows(IllegalArgumentException.class,
        () -> JSentinelEnforcer.requireAnyPermission());
    assertThrows(IllegalArgumentException.class,
        () -> JSentinelEnforcer.requireAnyPermission((String[]) null));
  }
  ...
  void requireRoleHeld() {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.requireRole("ADMIN"));
  }
  ...
  void requireAnyRoleHonoursHierarchy() {
    bind(new TestUser("alice", Set.of("ADMIN"), Set.of()));
    JSentinelServiceResolver.setRoleHierarchy(new RoleHierarchy() {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.requireRole("VIEWER"));
  }
  ...
  void requireAnyRoleEmpty() {
    bind(new TestUser("alice", Set.of("ADMIN"), Set.of()));
    assertThrows(IllegalArgumentException.class,
        () -> JSentinelEnforcer.requireAnyRole());
    assertThrows(IllegalArgumentException.class,
        () -> JSentinelEnforcer.requireAnyRole((String[]) null));
  }
  ...
  void requirePolicyAllowed() {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.requirePolicy("any-policy"));
  }
  ...
  void requirePolicyDenied() {
    ...
    AccessDeniedException ex = assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.requirePolicy("doc-owner"));
  ...
  void requirePolicyStepUp() {
    ...
    AccessDeniedException ex = assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.requirePolicy("doc-sensitive"));
  ...
  void requirePolicyWithContext() {
    ...
    JSentinelServiceResolver.setPolicyRegistry(capturing);
    JSentinelEnforcer.requirePolicy("doc.read", "document", "doc-42", "read");
  ...
  void enforceClassLevelPermissionHeld() throws Exception {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.enforce(m, AnnotatedClass.class));
  }
  ...
  void enforceClassLevelPermissionMissing() throws Exception {
    ...
    assertThrows(AccessDeniedException.class,
        () -> JSentinelEnforcer.enforce(m, AnnotatedClass.class));
  }
  ...
  void enforceClassLevelRole() throws Exception {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.enforce(m, AdminClass.class));
  }
  ...
  void enforceUnannotated() throws Exception {
    ...
    assertDoesNotThrow(
        () -> JSentinelEnforcer.enforce(m, NoAnnotationClass.class));
  }
  ...
  void enforceAnyPermission() throws Exception {
    ...
    assertDoesNotThrow(() -> JSentinelEnforcer.enforce(m, MixedClass.class));
  }
