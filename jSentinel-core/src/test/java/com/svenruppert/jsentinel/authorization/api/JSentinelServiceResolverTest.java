...
import com.svenruppert.jsentinel.action.ActionPermission;
...
class JSentinelServiceResolverTest {
  ...
  static class FirstAuthorizationService implements AuthorizationService<String> {
    @Override
    public com.svenruppert.jsentinel.authorization.api.roles.HasRoles rolesFor(String subject) {
  ...
  void passwordHashingService_defaultsToPbkdf2() {
    com.svenruppert.jsentinel.authentication.PasswordHasher hasher =
        JSentinelServiceResolver.passwordHashingService();
    assertTrue(hasher instanceof com.svenruppert.jsentinel.authentication.Pbkdf2PasswordHasher,
  ...
  void resetAll_clearsPasswordHasher() {
    ...
    com.svenruppert.jsentinel.authentication.PasswordHasher after =
        JSentinelServiceResolver.passwordHashingService();
    assertTrue(after instanceof com.svenruppert.jsentinel.authentication.Pbkdf2PasswordHasher);
  }

  static final class RecordingHasher implements com.svenruppert.jsentinel.authentication.PasswordHasher {
