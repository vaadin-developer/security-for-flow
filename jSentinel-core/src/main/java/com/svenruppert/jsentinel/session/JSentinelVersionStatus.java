...
/**
 * Result of a {@link JSentinelVersionCheck#check} call against a
...
public sealed interface JSentinelVersionStatus {
   ...
   *           {@link JSentinelVersionCheck} current value
   */
  record Current(JSentinelVersion at) implements JSentinelVersionStatus {
    ...
    @Override
    public JSentinelVersion snapshot() {
      return at;
    }

    @Override
    public JSentinelVersion current() {
      return at;
    }
  }
   ...
   */
  record Drifted(JSentinelVersion snapshot, JSentinelVersion current) implements JSentinelVersionStatus {
