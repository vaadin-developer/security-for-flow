...
import static com.svenruppert.jsentinel.demo.app.MySessionAccessor.isCurrentUserAuthorizedFor;
import static com.svenruppert.jsentinel.demo.app.security.roles.AuthorizationRole.*;
...
public class MainView
  ...
  private static final com.svenruppert.jsentinel.logout.LogoutService LOGOUT_SERVICE =
      new com.svenruppert.jsentinel.logout.vaadin.VaadinLogoutService<>(
          SubjectStores.subjectStore(), MyUser.class,
          new com.svenruppert.jsentinel.logout.vaadin.DefaultVaadinLogoutGateway(),
          "/" + MyLoginView.NAV,
  ...
  private void logout() {
    ...
    LOGOUT_SERVICE.logout(subjectId,
        com.svenruppert.jsentinel.logout.LogoutScope.CurrentSession);
  }
}