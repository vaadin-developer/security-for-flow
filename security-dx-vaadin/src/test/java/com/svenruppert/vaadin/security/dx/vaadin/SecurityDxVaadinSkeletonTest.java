 ...
 */
package com.svenruppert.vaadin.security.dx.vaadin;
 ...
 */
class SecurityDxVaadinSkeletonTest {
  ...
  void bootstrapPackageExists() {
    assertPackageInfoLoadable("com.svenruppert.vaadin.security.dx.vaadin.bootstrap");
  }

  @Test
  void runtimePackageExists() {
    assertPackageInfoLoadable("com.svenruppert.vaadin.security.dx.vaadin.runtime");
  }
}
