...
/**
 * Single source of truth for the jCustos metric-name catalog.
 *
 ...
 * {@link JCustosMetricsPublisher#increment(String, long)}) or a
 * <em>gauge</em> (push-style snapshot, emitted via
 * {@link JCustosMetricsPublisher#gauge(String, long)}), and where
 * the emission is expected to happen.</p>
 *
 * @since 00.80.00
 */
@ExperimentalJCustosApi
public final class JCustosMetricNames {
   ...
   * {@link JCustosMetricsPublisher#gauge(String, long)}.
   */
