 ...
 */
package eu.jsentinel.jcustos.autoservice.api;
...
class JSentinelAutoServiceAnnotationTest {

  @Test
  void annotationHasSourceRetention() {
    Retention retention = JSentinelAutoService.class.getAnnotation(Retention.class);
  ...
  void annotationTargetsType() {
    Target target = JSentinelAutoService.class.getAnnotation(Target.class);
