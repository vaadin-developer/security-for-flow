...
/**
 * @deprecated Use {@link com.svenruppert.vaadin.security.authorization.api.SecurityServiceResolver#loginListener()} instead.
 */
@Deprecated(since = "0.50.0", forRemoval = false)
public class LoginListenerProvider
        implements ServiceProvider<LoginListener> {
    @Override
    public Class<LoginListener> serviceInterface() {
