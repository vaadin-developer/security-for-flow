...
class AuthorizationPhaseDecisionTest {
  ...
  @Test
  @DisplayName("AuthorizationDecision.Granted converts to NavigationAccessDecision.Allowed")
  void grantedDecision_isAllowed() {
    ...
    AuthorizationDecision authDecision = AuthorizationDecision.granted();
    assertInstanceOf(AuthorizationDecision.Granted.class, authDecision);
  }

  @Test
  @DisplayName("AuthorizationDecision.Denied maps to NavigationAccessDecision.AccessDenied concept")
  void deniedDecision_carriesRoute() {
    AuthorizationDecision authDecision = AuthorizationDecision.denied("login", true);
    assertInstanceOf(AuthorizationDecision.Denied.class, authDecision);
    var denied = (AuthorizationDecision.Denied) authDecision;
