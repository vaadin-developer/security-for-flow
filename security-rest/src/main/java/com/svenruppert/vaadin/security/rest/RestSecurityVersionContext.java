 ...
 * {@link RestSubjectResolver} so {@link RestSecurityVersionFilter}
 ...
 * {@link RestSubjectResolver#resolveSecurityVersionContext(RestRequest)}
...
public record RestSecurityVersionContext(
    SubjectId subjectId,
    TenantId tenant,
  ...
  public RestSecurityVersionContext {
