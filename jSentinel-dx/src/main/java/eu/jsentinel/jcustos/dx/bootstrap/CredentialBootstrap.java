...
public interface CredentialBootstrap {
   ...
   * {@code JCustosRuntime} reports them as two separate entries —
   ...
   * throws {@code JCustosBootstrapException} with code
