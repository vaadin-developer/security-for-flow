 ...
 * {@link JCustosDiagnostics#inspect()}.
 *
 * @since 00.72.00
 */
public record JCustosProcessorReport(
    List<GeneratedJCustosWrapper> wrappers,
    List<ProcessorWarning> warnings) {

  public JCustosProcessorReport {
  ...
  public static JCustosProcessorReport empty() {
    return new JCustosProcessorReport(List.of(), List.of());
  }
}
