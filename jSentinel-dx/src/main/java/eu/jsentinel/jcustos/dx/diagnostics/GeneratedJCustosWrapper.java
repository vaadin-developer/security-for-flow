 ...
 * @since 00.72.00
 */
public record GeneratedJCustosWrapper(
    Class<?> sourceType,
    Class<?> generatedType,
    String processor,
   ...
   * {@code jCustos-processor}.<br>
   * {@link #PROPAGATING}: @PropagateToken token-propagation wrapper
   * from {@code jCustos-propagation-processor}.
   *
   * @since 00.74.00
   */
  public enum Kind { SECURED, PROPAGATING }

  public GeneratedJCustosWrapper {
   ...
   */
  public GeneratedJCustosWrapper(Class<?> sourceType,
                                    Class<?> generatedType,
                                    String processor,
                                    String proxyBuilderVersion,
                                    List<String> delegatedMethods) {
