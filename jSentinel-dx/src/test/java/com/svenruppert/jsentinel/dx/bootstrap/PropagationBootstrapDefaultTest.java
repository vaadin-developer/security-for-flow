...
import com.svenruppert.jsentinel.dx.internal.PropagationState;
import com.svenruppert.jsentinel.dx.internal.RecordingPropagationBootstrap;
...
class PropagationBootstrapDefaultTest {
  ...
  private static final class OtherStrategy
      implements com.svenruppert.jsentinel.credential.propagation.OutboundTokenStrategy {
    @Override public String name() { return "other"; }
    @Override public java.util.Optional<
        com.svenruppert.jsentinel.credential.propagation.HeaderValue> resolve(
            com.svenruppert.jsentinel.credential.propagation.OutboundCall call,
            java.util.Optional<
                com.svenruppert.jsentinel.credential.propagation.TokenCredential> inbound) {
