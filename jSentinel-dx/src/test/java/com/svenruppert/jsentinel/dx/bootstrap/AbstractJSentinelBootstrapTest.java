...
class AbstractJSentinelBootstrapTest {
  ...
  static final class BootstrapStateAccessor {
    final com.svenruppert.jsentinel.dx.internal.BootstrapState state;
    BootstrapStateAccessor(com.svenruppert.jsentinel.dx.internal.BootstrapState s) {
      this.state = s;
    }
  }
  ...
  void subBuilderCallbacksInvokedExactlyOnce() {
    ...
    b.audit(a -> { auditCalls.incrementAndGet(); a.ringBuffer(256); })
     ...
     .policies(p -> {
       ...
       p.register(com.svenruppert.jsentinel.policy.api.Policy.named("dummy")
