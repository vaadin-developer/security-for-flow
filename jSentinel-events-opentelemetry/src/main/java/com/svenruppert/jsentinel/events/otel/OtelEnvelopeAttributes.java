...
/**
 * The OpenTelemetry attribute vocabulary of the jSentinel envelope-to-log
...
public final class OtelEnvelopeAttributes {
  ...
  public static final String INSTRUMENTATION_SCOPE = "com.svenruppert.jsentinel.events";
