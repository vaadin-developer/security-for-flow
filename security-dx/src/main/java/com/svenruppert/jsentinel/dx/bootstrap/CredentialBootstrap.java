 ...
 * </ul>
 *
 * <p>{@link #passwordReset(com.svenruppert.jsentinel.credential.reset.PasswordResetService)}
...
public interface CredentialBootstrap {
   ...
   *                {@code com.svenruppert.jsentinel.credential.reset.PasswordResetService}
   *                (NOT the V00.70
   *                {@code com.svenruppert.jsentinel.accountlifecycle.PasswordResetService}
