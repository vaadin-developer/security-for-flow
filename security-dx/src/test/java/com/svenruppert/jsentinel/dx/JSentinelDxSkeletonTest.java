 ...
 */
package com.svenruppert.jsentinel.dx;
...
class JSentinelDxSkeletonTest {
  ...
  void bootstrapPackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.bootstrap");
  }

  @Test
  void diagnosticsPackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.diagnostics");
  }

  @Test
  void runtimePackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.runtime");
  }
}
