 ...
 */
package eu.jsentinel.jcustos.dx.standalone;
...
class JSentinelDxStandaloneSkeletonTest {
  ...
  void bootstrapPackageExists() {
    assertPackageInfoLoadable("eu.jsentinel.jcustos.dx.standalone.bootstrap");
  }

  @Test
  void runtimePackageExists() {
    assertPackageInfoLoadable("eu.jsentinel.jcustos.dx.standalone.runtime");
  }
}
