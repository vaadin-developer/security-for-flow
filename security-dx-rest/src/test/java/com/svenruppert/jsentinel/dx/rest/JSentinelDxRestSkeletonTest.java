 ...
 */
package com.svenruppert.jsentinel.dx.rest;
...
class JSentinelDxRestSkeletonTest {
  ...
  void bootstrapPackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.rest.bootstrap");
  }

  @Test
  void runtimePackageExists() {
    assertPackageInfoLoadable("com.svenruppert.jsentinel.dx.rest.runtime");
  }
}
