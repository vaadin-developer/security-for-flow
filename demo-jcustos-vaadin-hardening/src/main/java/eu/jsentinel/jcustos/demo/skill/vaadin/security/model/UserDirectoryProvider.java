 ...
 * under {@code ./data/jcustos-vaadin-persistence/users}, then injects it into a
...
public final class UserDirectoryProvider {
  ...
  public static final Path USERS_STORAGE_DIR = Path.of("./data/jcustos-vaadin-persistence/users");
