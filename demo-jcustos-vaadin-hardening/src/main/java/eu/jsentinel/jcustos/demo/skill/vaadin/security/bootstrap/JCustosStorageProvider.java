 ...
 * Eclipse-Store layer at {@code ./data/jcustos-vaadin-persistence} and registers a
...
public final class JCustosStorageProvider {
  ...
  public static final Path DEFAULT_STORAGE_DIR = Path.of("./data/jcustos-vaadin-persistence");
