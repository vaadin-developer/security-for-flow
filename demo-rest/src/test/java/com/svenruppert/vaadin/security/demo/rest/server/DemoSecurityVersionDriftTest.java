 ...
 * {@link RestSecurityVersionFilter} as wired by
...
@DisplayName("Demo REST server — SecurityVersion drift detection")
class DemoSecurityVersionDriftTest {
  ...
  @Test
  @DisplayName("Role change bumps SecurityVersion → stale token returns 401 + WWW-Authenticate: SessionStale")
  ...
  @Test
  @DisplayName("SecurityVersion drift emits a SessionStale audit event")
