...
import static eu.jsentinel.jcustos.demo.standalone.Permission.BOOK_ADD;
import static eu.jsentinel.jcustos.demo.standalone.Permission.BOOK_BORROW;
import static eu.jsentinel.jcustos.demo.standalone.Permission.BOOK_LIST;
import static eu.jsentinel.jcustos.demo.standalone.Permission.BOOK_REMOVE;
import static eu.jsentinel.jcustos.demo.standalone.Permission.BOOK_RETURN;
import static eu.jsentinel.jcustos.demo.standalone.Permission.MEMBER_ADD;
import static eu.jsentinel.jcustos.demo.standalone.Permission.MEMBER_AUDIT_LOG;
import static eu.jsentinel.jcustos.demo.standalone.Permission.MEMBER_INVITE;
