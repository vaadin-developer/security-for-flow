...
/**
 * Vaadin service initializer that registers the {@link eu.jsentinel.jcustos.authorization.LoginListener}
  ...
  public void serviceInit(ServiceInitEvent e) {
    e.getSource()
        .addUIInitListener((UIInitListener) uiInitEvent -> {
          ...
          LoginListeners.findLoginListener()
              .ifPresentOrElse(
                  loginListener -> {
